...
<body>
    ...
    <center>
        ...
        <br>
        <br>
        <a href="modalidade.php" class="btn btn-primary" role="button">Voltar</a>
    </center>

    <div class="container">

        <form class="row g-3" action="modalidade_insere.php" method="post">
            <div class="col-md-6">
                <label for="nome" class="form-label">Modalidade</label>
