...
<body>
    ...
    <center>
        ...
        <br>
        <br>
        <a href="cursos_formulario.php" class="btn btn-primary" role="button">Cadastrar atleta</a>
    </center>
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th scope="col">status_mensalidade</th>
                <th scope="col"></th>
            </tr>
        </thead>
        <tbody>
...
<?php
        while($row = $result->fetch_assoc()) {
            ...
            echo "<td>". $row["status_mensalidade"] ."</td>";
